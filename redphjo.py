...
for g in g0fs:
    ...
    Qlrs.append(ql0.real+qr0.real + qph.real)
    Qphs.append(qph.real)
...
plt.xlabel(r'$\frac{g}{ \kappa_{l}}$',fontsize = 20)   
plt.xscale("log")
plt.legend()
plt.show()

plt.plot(gof1,cohev,lw = 3,label = r'$\mathcal{C}_{l_{1}}$', color = 'b')
plt.plot(gof1,concuv, lw = 3,label = r'$\mathcal{C}_{on}$', color = 'r')  
plt.xlabel(r'$\frac{g}{ \kappa_{l}}$',fontsize = 20)   
plt.xscale("log")
plt.legend()
plt.show()

plt.plot(gof1,Qlrs,lw = 3,label = r'$J_{LRph}$', color = 'b') 
plt.xlabel(r'$\frac{g}{\kappa_{l}}$',fontsize = 20)   
plt.xscale("log")
plt.legend()
plt.show()

plt.plot(gof1,Imalphg,lw = 3,label = r'$2g \mathrm{Im}(\alpha)$', color = 'b') 
plt.xlabel(r'$\frac{g}{ \kappa_{l}}$',fontsize = 20)   
plt.xscale("log")
plt.legend()
plt.show()

plt.plot(gof1,Imbetg,lw = 3,label = r'$2g \mathrm{Im}(\alpha)$', color = 'b') 
plt.xlabel(r'$\frac{g}{ \kappa_{l}}$',fontsize = 20)   
plt.xscale("log")
plt.legend()
plt.show()

plt.plot(gof1,Qphs,lw = 3,label = r'$J_{phonon}$', color = 'b') 
plt.xlabel(r'$\frac{g}{ \kappa_{l}}$',fontsize = 20)   
plt.xscale("log")
plt.legend()
plt.show()
...
for i in range(Num):
    ...
    archivo.write(" ")
    archivo.write( format_str.format(Qls[i]))
    archivo.write(" ")
    archivo.write( format_str.format(Qrs[i]))
    archivo.write(" ")
    archivo.write( format_str.format(Qlrs[i]))
    archivo.write(" ")   
